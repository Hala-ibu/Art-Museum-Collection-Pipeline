...
SCOPES = os.getenv("SCOPES").split(",") if os.getenv("SCOPES") else ["https://www.googleapis.com/auth/drive.file"]
...
def upload_image(local_path, folder_id=FOLDER_ID):
    ...
    mime_type = 'image/webp' if local_path.suffix.lower() == '.webp' else 'image/jpeg'
